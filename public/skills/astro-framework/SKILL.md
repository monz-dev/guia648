...
| Data Fetching | [rules/astro-data-fetching.rule.md](rules/astro-data-fetching.rule.md) | SSG, client-side fetch, external APIs |
...
- `rules/astro-data-fetching.rule.md` → Data fetching (SSG, client-side, external APIs)
